...
$(kernel_object_files): build/kernel/%.o : src/kernel
	mkdir -p $(dir $@) && \
	x86_64-linux-gnu-gcc -c -I src/ -ffreestanding $(patsubst build/kernel/%.o, src/kernel/%.c, $@) -o $@

$(x86_64_c_object_files): build/x86_64/%.o : src/x86_64
	mkdir -p $(dir $@) && \
	x86_64-linux-gnu-gcc -c -I src/ -ffreestanding $(patsubst build/x86_64/%.o, src/x86_64/%.c, $@) -o $@

$(x86_64_asm_object_files): build/x86_64/%.o : src/x86_64
	mkdir -p $(dir $@) && \
